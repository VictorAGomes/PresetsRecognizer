...
class PresetRecognizer:
    ...
    Pipeline: pré-processamento -> ORB -> Lowe ratio test
    """
    def __init__(
        self,
        ...
        Args:
            num_features: número máximo de features ORB por imagem.
    ...
    def _compute_descriptors(
        ...
        """
        Detecta keypoints e descritores ORB de forma segura.
        """
        if imagem is None:
            return [], None
        try:
            keypoints, descriptors = self.orb.detectAndCompute(imagem, None)
        except Exception as e:
            logger.warning(f"Falha ao detectar/calcular descritores ORB: {e}")
            return [], None
    ...
    def _computar_descritores_presets(self) -> None:
        """
        Computa descritores ORB para todos os presets em self.presets_referencia.
        """
